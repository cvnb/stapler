...
class TestStapler(unittest.TestCase):
    ...
    def test_cat(self):
        ...
        with open(self.outputfile, 'rb') as outputfile:
            ...
            self.assertEqual(pdf.get_num_pages(), 6)
    ...
    def test_sel_one_page(self):
        ...
        with open(self.outputfile, 'rb') as outputfile:
            pdf = PdfReader(outputfile)
            self.assertEqual(pdf.get_num_pages(), 1)
    ...
    def test_sel_range(self):
        ...
        with open(self.outputfile, 'rb') as outputfile:
            pdf = PdfReader(outputfile)
            self.assertEqual(pdf.get_num_pages(), 3)
    ...
    def test_del_one_page(self):
        ...
        with open(self.outputfile, 'rb') as outputfile:
            pdf = PdfReader(outputfile)
            self.assertEqual(pdf.get_num_pages(), 4)
    ...
    def test_del_range(self):
        ...
        with open(self.outputfile, 'rb') as outputfile:
            pdf = PdfReader(outputfile)
            self.assertEqual(pdf.get_num_pages(), 2)
    ...
    def test_background(self):
        ...
        with open(self.outputfile, 'rb') as outputfile:
            pdf = PdfReader(outputfile)
            self.assertEqual(pdf.get_num_pages(), 5)
